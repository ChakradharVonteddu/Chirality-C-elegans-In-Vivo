...
def plot_fit(data, angles):
    ...
    axD.plot(dorsal_t_passed, da_average_passed, "o", markersize=4, color="none", markeredgecolor="blue")
    axD.plot(dorsal_t_npassed, da_average_npassed, "o", label="ABa data (shading is CI)", markersize=4, color='none', markeredgecolor="blue")
    ...
    axD.plot(dorsal_t_passed, dp_average_passed, "o", markersize=4, color="none", markeredgecolor="red")
    axD.plot(dorsal_t_npassed, dp_average_npassed, "o", label="ABp data (shading is CI)", markersize=4, color='none', markeredgecolor="red")
    ...
    axA.plot(anterior_t_passed, aa_average_passed, "o", markersize=4, color='none', markeredgecolor="blue")
    axA.plot(anterior_t_npassed, aa_average_npassed, "o", label="ABa data (shading is CI)", markersize=4, color='none', markeredgecolor="blue")
    ...
    axA.plot(anterior_t_passed, ap_average_passed, "o", markersize=4, color='none', markeredgecolor="red")
    axA.plot(anterior_t_npassed, ap_average_npassed, "o", label="ABp data (shading is CI)", markersize=4, color='none', markeredgecolor="red")
    ...
    # save figure
#    filename = f"fit_E0_{E0:.2f}_E1_{E1:.2f}_FSL_{FINAL_SPRING_LENGTH:.2f}_LAM_{LAM:.3f}.png"  
    filename = f"fit_E0_{E0:.2f}_E1_{E1:.2f}_FSL_{FINAL_SPRING_LENGTH:.2f}_LAM_{LAM:.3f}.pdf"  
